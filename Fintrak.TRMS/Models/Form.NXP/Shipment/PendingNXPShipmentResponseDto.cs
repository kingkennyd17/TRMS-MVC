...
{
    public class PendingNXPShipmentResponseDto
    {
        public int responseCode { get; set; }
        public string responseMessage { get; set; }
        public PendingNXPShipmentResponseResultDto responseResult { get; set; }
    }

    public class PendingNXPShipmentResponseResultDto
    {
        public PendingNXPShipmentContentDto[] content { get; set; }
    ...
    public class PendingNXPShipmentContentDto
    {
