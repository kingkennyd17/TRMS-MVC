...
namespace Fintrak.TRMS.FormNXPResponseDto
{
    ...
    public class ResponseResultNessPayment
    {
        ...
        public double nessLevyPaid { get; set; }
        public long nessLevyDate { get; set; }
    ...
    public class NessLevyPaymentResponseDto
    {
        public int responseCode { get; set; }
        public string responseMessage { get; set; }
        public ResponseResultNessPayment responseResult { get; set; }
    }
